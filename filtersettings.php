...
if ($ADMIN->fulltree) {
	...
	// $name = 'filter_coursecatalogue_rebuild';
	// $title = 'rebuild database view';
	// $description = html_writer::link(new moodle_url('/filter/coursecatalogue/rebuild.php'), "click here");
